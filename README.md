...
## Background
Using data provided from the 2024 BRFSS Survey conducted by the CDC, we plan to evaluate how likely an individual is to use an e-cigarette based on their lifestyle.
